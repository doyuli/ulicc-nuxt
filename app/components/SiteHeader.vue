...
<template>
  <header :class="cn('fixed w-full top-0 left-0 z-10 h-(--header-height)', headerBgClass)">
    <div :class="cn('grid grid-cols-2 sm:grid-cols-3 items-center mx-auto size-full', global.appShellClass)">
      ...
      <div :class="cn('hidden sm:flex items-center justify-center relative size-full', isScrolling && 'overflow-hidden')">
        <div
          :class="cn(
      ...
      <div class="flex gap-4 items-center justify-end">
        ...
        <RandomPost />
        <ColorMode />
        <MobileMode :menus="navigation" class="sm:hidden" />
